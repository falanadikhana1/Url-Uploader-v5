...
ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : [в34ѕтz](https://telegram.me/B34STZ)
 
"""
    ABOUT_TEXT = """
**Mʏ ɴᴀᴍᴇ** : [ʟᴜᴄɪꜰᴇʀ ᴠɪᴅ ʙᴏᴛ](http://t.me/LuciferVidBot)

**Cʜᴀɴɴᴇʟ** : [в34ѕтz](https://telegram.me/B34STZ)

**Vᴇʀꜱɪᴏɴ** : [2.0 ʙᴇᴛᴀ](http://t.me/LuciferVidBot)
...
**Dᴇᴠᴇʟᴏᴘᴇʀ :** [ʙᴇ4ꜱᴛx](https://t.me/Be4stX)
...
"""
    ...
    NOYES_URL = "@LuciferVidBot URL detected. Please use http://b34stx.tk and get me a fast URL so that I can upload to Telegram, without me slowing down for other users."
    ...
    NOT_AUTH_USER_TEXT_FILE_SIZE = "Detected File Size: {}. Free Users can only upload: {}\nPlease /upgrade your subscription.\nIf you think this is a bug, please contact <a href='https://telegram.dog/ThankTelegram'>@Be4stX</a>"
    ...
    FF_MPEG_RO_BOT_AD_VER_TISE_MENT = "Join : @B34STZ \n For Updates. "
    EXTRACT_ZIP_INTRO_ONE = "Send a compressed file first, Then reply /unzip command to the file."
    EXTRACT_ZIP_INTRO_THREE = "Analyzing received file. ⚠️ This might take some time. Please be patient. "
    UNZIP_SUPPORTED_EXTENSIONS = ("zip", "rar")
    EXTRACT_ZIP_ERRS_OCCURED = "Sorry. Errors occurred while processing compressed file. Please check everything again twice, and if the issue persists, report this to <a href='https://telegram.dog/ThankTelegram'>@Be4stX</a>"
